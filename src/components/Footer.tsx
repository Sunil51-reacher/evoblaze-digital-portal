      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/services#seo" className="text-gray-300 hover:text-white">SEO & Content</Link></li>
              <li><Link to="/services#social-media" className="text-gray-300 hover:text-white">Social Media</Link></li>
              <li><Link to="/services#web-development" className="text-gray-300 hover:text-white">Web Development</Link></li>
              <li><Link to="/services#branding" className="text-gray-300 hover:text-white">Branding</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-center md:text-left">
            &copy; {currentYear} Evoblaze. All rights reserved.
          </p>
